...
class FavoredEnemy(Feature):
    ...
    name = _("Favored Enemy")
    source = _("Ranger")
    languages = (_("[Select One]"),)


class NaturalExplorer(Feature):
    __doc__ = _("""You are particularly familiar with one type of natural environment
...
class Defense(Feature):
    ...
    name = _("Fighting Style (Defense)")
    source = _("Ranger")


class Dueling(Feature):
    __doc__ = _("""When you are wielding a melee weapon in one hand and no other weapons, you
    gain a +2 bonus to damage rolls with that weapon.

    """)

    name = _("Fighting Style (Dueling)")
    source = _("Ranger")
...
class TwoWeaponFighting(Feature):
    __doc__ = _("""When you engage in two-weapon fighting, you can add your ability modifier
    to the damage of the second attack.

    """)

    name = _("Fighting Style (Two-Weapon Fighting)")
    source = _("Ranger")
...
class RangerFightingStyle(FeatureSelector):
    ...
    name = _("Fighting Style (Select One)")
    source = _("Ranger")


class PrimevalAwareness(Feature):
    __doc__ = _("""Beginning at 3rd level, you can use your action and expend one ranger spell
    ...
    name = _("Primeval Awareness")
    source = _("Ranger")


class ExtraAttackRanger(Feature):
    __doc__ = _("""Beginning at 5th level, you can attack twice, instead of once, whenever you
    take the Attack action on your turn.

    """)

    name = _("Extra Attack (2x)")
    source = _("Ranger")

class LandsStride(Feature):
    __doc__ = _("""Starting at 8th level, moving through nonmagical difficult terrain costs you
    no extra movement. You can also pass through nonmagical plants without being slowed 
    by them and without taking damage from them if they have thorns, spines, or a similar hazard.
    ...
    name = _("Land's Stride")
    source = _("Ranger")


class HideInPlainSight(Feature):
    __doc__ = _("""Starting at 10th level, you can spend 1 minute creating camouflage for
    ...
    name = _("Hide in Plain Sight")
    source = _("Ranger")


class Vanish(Feature):
    __doc__ = _("""Starting at 14th level, you can use the Hide action as a bonus action on
...
class FeralSenses(Feature):
    __doc__ = _("""At 18th level, you gain preternatural senses that help you fight creatures
...
class FoeSlayer(Feature):
    __doc__ = _("""At 20th level, you become an unparalleled hunter of your enemies. Once on
...
class ColossusSlayer(Feature):
    __doc__ = _("""Your tenacity can wear down the most potent foes. When you hit a creature
    ...
    name = _("Colossus Slayer")
    source = _("Ranger (Hunter)")


class GiantKiller(Feature):
    __doc__ = _("""When a Large or larger creature within 5 feet of you hits or misses you
...
class HordeBreaker(Feature):
    __doc__ = _("""Once on each o f your turns when you make a weapon attack, you can make
    ...
    name = _("Horde Breaker")
    source = _("Ranger (Hunter)")


class HuntersPrey(FeatureSelector):
    __doc__ = _("""Select a Hunter's Prey option in "feature_choices" in your .py file from
    one of:
    ...
    name = _("Hunter's Prey (Select One)")
    source = _("Ranger (Hunter)")


class EscapeTheHorde(Feature):
    __doc__ = _("""Opportunity attacks against you are made with disadvantage""")

    name = _("Escape the Horde")
    source = _("Ranger (Hunter)")


class MultiattackDefense(Feature):
    __doc__ = _("""When a creature hits you with an attack, you gain a +4 bonus to AC against
    all subsequent attacks made by that creature for the rest of the turn.

    """)

    name = _("Multiattack Defense")
    source = _("Ranger (Hunter)")


class SteelWill(Feature):
    __doc__ = _("""You have advantage on saving throws against being frightened.""")
...
class DefensiveTactics(FeatureSelector):
    __doc__ = _("""Select a Defensive Tactics option in "feature_choices" in your .py file from
    one of:
    ...
    name = _("Defensive Tactics (Select One)")
    source = _("Ranger (Hunter)")


class Volley(Feature):
    __doc__ = _("""You can use your action to make a ranged attack against any number of
...
class WhirlwindAttack(Feature):
    __doc__ = _("""You can use your action to make a melee attack against any number o f
    creatures within 5 feet of you, with a separate attack roll for each target

    """)

    name = _("Whirlwind Attack")
    source = _("Ranger (Hunter)")


class MultiattackRanger(FeatureSelector):
    __doc__ = _("""Select a Multiattack option in "feature_choices" in your .py file from
    one of:
    ...
    name = _("Multiattack (Select One)")
    source = _("Ranger (Hunter)")


class StandAgainstTheTide(Feature):
    __doc__ = _("""When a hostile creature misses you with a melee attack, you can use your
    reaction to force that creature to repeat the same attack against another
    creature (other than itself) of your choice

    """)

    name = _("Stand Against the Tide")
    source = _("Ranger (Hunter)")


class SuperiorHuntersDefense(FeatureSelector):
    __doc__ = _("""Select a Superior Hunter's Defense option in "feature_choices" in your .py
    file from one of:
    ...
    name = _("Superior Hunter's Defense (Select One)")
    source = _("Ranger (Hunter)")


# Beast Master
class RangersCompanion(Feature):
    __doc__ = _("""At 3rd level, you gain a beast companion that accompanies you on your
    ...
    name = _("Ranger's Companion")
    source = _("Ranger (Beast Master)")


class ExceptionalTraining(Feature):
    __doc__ = _("""Beginning at 7th level, on any of your turns when your beast companion
    ...
    name = _("Exceptional Training")
    source = _("Ranger (Beast Master)")


class BestialFury(Feature):
    __doc__ = _("""Starting at 11th level, your beast companion can make two attacks when you
...
class ShareSpells(Feature):
    __doc__ = _("""Beginning at 15th level, when you cast a spell targeting yourself, you can
...
class DreadAmbusher(Feature):
    __doc__ = _("""At 3rd level, you master the art of the ambush. You can give yourself a
    ...
    name = _("Dread Ambusher")
    source = _("Ranger (Gloom Stalker)")


class UmbralSight(Feature):
    __doc__ = _("""At 3rd level, you gain darkvision out to a range of 60 feet. If you already
...
class IronMind(Feature):
    __doc__ = _("""By 7th level, you have honed your ability to resist the mind-altering
...
class StalkersFlurry(Feature):
    __doc__ = _("""At 11th level, you learn to attack with such unexpected speed that you can
    ...
    name = _("Stalker's Flurry")
    source = _("Ranger (Gloom Stalker)")


class ShadowyDodge(Feature):
    __doc__ = _("""Starting at 15th level, you can dodge in unforeseen ways, with wisps of
    ...
    name = _("Shadowy Dodge")
    source = _("Ranger (Gloom Stalker)")


# Horizon Walker
class DetectPortal(Feature):
    __doc__ = _("""At 3rd level, you gain the ability to magically sense the presence of a
    ...
    name = _("Detect Portal")
    source = _("Ranger (Horizon Walker)")


class PlanarWarrior(Feature):
    __doc__ = _("""At 3rd level, you learn to draw on the energy of the multiverse to
    ...
    name = _("Planar Warrior")
    source = _("Ranger (Horizon Walker)")

    @property
    def name(self):
        if self.owner.Ranger.level < 11:
            return self.name + " (1d8/f)"
        else:
            return self.name + " (2d8/f)"


class EtherealStep(Feature):
    __doc__ = _("""At 7th level, you learn to step through the Ethereal Plane. As a bonus
    ...
    name = _("Ethereal Step")
    source = _("Ranger (Horizon Walker)")


class DistantStrike(Feature):
    __doc__ = _("""At 11th level, you gain the ability to pass between the planes in the blink
    ...
    name = _("Distant Strike")
    source = _("Ranger (Horizon Walker)")


class SpectralDefense(Feature):
    __doc__ = _("""At 15th level, your ability to move between planes enables you to slip
    ...
    name = _("Spectral Defense")
    source = _("Ranger (Horizon Walker)")


# Monster Slayer
class HuntersSense(Feature):
    __doc__ = _("""At 3rd level, you gain the ability to peer at a creature and magically
    ...
    _name = _("Hunter's Sense")
    source = _("Ranger (Monster Slayer)")
...
class SlayersPrey(Feature):
    __doc__ = _("""Starting at 3rd level, you can focus your ire on one foe, increasing the
    ...
    name = _("Slayer's Prey")
    source = _("Ranger (Monster Slayer)")


class SupernaturalDefense(Feature):
    __doc__ = _("""At 7th level, you gain extra resilience against your prey's assaults on
    ...
    name = _("Supernatural Defense")
    source = _("Ranger (Monster Slayer)")


class MagicUsersNemesis(Feature):
    __doc__ = _("""At 11th level, you gain the ability to thwart someone else's magic. When
    ...
    name = _("Magic User's Nemesis")
    source = _("Ranger (Monster Slayer)")


class SlayersCounter(Feature):
    __doc__ = _("""At 15th level, you gain the ability to counterattack when your prey tries
    ...
    name = _("Slayer's Counter")
    source = _("Ranger (Monster Slayer)")


# Revised Ranger
class FavoredEnemyRevised(Feature):
    __doc__ = _("""Beginning at 1st level, you have significant experience studying, tracking,
    ...
    name = _("Favored Enemy")
    source = _("Revised Ranger")


class NaturalExplorerRevised(Feature):
    __doc__ = _("""You are a master of navigating the natural world, and you react
...
class PrimevalAwarenessRevised(Feature):
    __doc__ = _("""Beginning at 3rd level, your mastery of ranger lore allows you to establish
...
class GreaterFavoredEnemy(Feature):
    __doc__ = _("""At 6th level, you are ready to hunt even deadlier game. Choose a type of
    ...
    name = _("Greated Favored Enemy")
    source = _("Revised Ranger")


class FleetOfFoot(Feature):
    __doc__ = _("""Beginning at 8th level, you can use the Dash action as a bonus action on
    your turn.
...
class HideInPlainSightRevised(Feature):
    __doc__ = _("""Starting at 10th level, you can remain perfectly still for long periods of
...
class AnimalCompanion(Feature):
    __doc__ = _("""At 3rd level, you learn to use your magic to create a powerful bond with a
    ...
    source = _("Revised Ranger (Animal Companion)")


class CompanionsBond(Feature):
    __doc__ = _("""Your animal companion gains a variety of benefits while it is linked to
    ...
    name = _("Companions Bond")
    source = _("Revised Ranger (Beast Conclave)")


class CoordinatedAttack(Feature):
    __doc__ = _("""Beginning at 5th level, you and your animal companion form a more potent
    ...
    name = _("Coordinated Attack")
    source = _("Revised Ranger (Beast Conclave)")


class BeastsDefense(Feature):
    __doc__ = _("""At 7th level, while your companion can see you, it has advantage on all
    saving throw

    """)

    name = _("Beast's Defense")
    source = _("Revised Ranger (Beast Conclave)")


class StormOfClawsAndFangs(Feature):
    __doc__ = _("""At 11th level, your companion can use its action to make a melee attack
    against each creature of its choice within 5 feet of it, with a separate
    attack roll for each target

    """)

    name = _("Storm of Claws and Fangs")
    source = _("Revised Ranger (Beast Conclave)")


class SuperiorBeastsDefense(Feature):
    __doc__ = _("""At 15th level, whenever an attacker that your companion can see hits it
    with an attack, it can use its reaction to halve the attack's damage
    against it.

    """)

    name = _("Superior Beast's Defense")
    source = _("Revised Ranger (Beast Conclave)")


# Deep Stalker Conclave
class UnderdarkScout(Feature):
    __doc__ = _("""At 3rd level, you master the art of the ambush. On your first turn during
    ...
    name = _("Underdark Scout")
    source = _("Revised Ranger (Deep Stalker Conclave)")


class StalkersDodge(Feature):
    __doc__ = _("""At 15th level, whenever a creature attacks you and does not have advantage,
